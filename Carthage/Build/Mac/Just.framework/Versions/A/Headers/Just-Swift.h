...
- (NSString * _Nonnull)query:(NSDictionary<NSString *, id> * _Nonnull)parameters SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)percentEncodeString:(id _Nonnull)originalObject SWIFT_WARN_UNUSED_RESULT;
