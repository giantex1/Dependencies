...
+ (NSError *)errorWithCode:(OSStatus) code {
	...
	dispatch_once(&onceToken, ^{
		NSURL *url = [[NSBundle bundleForClass:[SAMKeychainQuery class]] URLForResource:@"SAMKeychain" withExtension:@".h"];
	...
	switch (code) {
		...
		case SAMKeychainErrorBadArguments: message = NSLocalizedString(@"Some of the arguments were invalid.",@"Some of the arguments were invalid.:"); break;
