...
@private
    // This has to be __*unsafe_unretained* because of 10.7 which refuses to
    // allow weak refs to point to NSViewController (causes crash)
	IBOutlet id <MGScopeBarDelegate, NSObject> __unsafe_unretained delegate;
	...
	BOOL _popupsShrunk; // Whether we have any popups which are currently shrunk
...
// Whether to notify the delegate of default selections
